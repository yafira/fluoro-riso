...
The full write-up behind [Fluoro](../README.md): how the print is built, why it's built that way, and how the tool at [fluoro-riso.vercel.app](https://fluoro-riso.vercel.app) is put together. For installing and using the package, see the [README](../README.md).

![The Fluoro press panel: a halftoned landscape with the load, reprint and print-flaw controls underneath it, and the ink and screen settings beside it](images/ui-press.png)
...
![The layout demo: text, a button, and two overlapping ink discs that multiply where they cross, next to a halftone gradient swatch](images/ui-layout.png)

## How the canvas pipeline works

![Six stages of the pipeline on a detail crop: source, two coverage maps, two screened ink layers, and the overprinted result](images/pipeline.png)
...
![The same crop screened three ways: halftone dots, Bayer dither, and random grain](images/modes.png)
...
![The headline printed twice in two inks with the second pass offset by 0, 2 and 8 pixels](images/misregistration.png)
...
![The sample image printed with pink and blue, orange and teal, and green and purple](images/inks.png)
...
![Three prints of the same crop: the first pull, a reprint with shifted dots and a new offset direction, and the same pull with the inks swapped](images/reprint.png)
...
![A mock shop page shown twice: the original, and the same markup after the SVG filter](images/filter.png)
...
docs/process.md   this write-up
docs/images/      screenshots and figures used in the docs
```
